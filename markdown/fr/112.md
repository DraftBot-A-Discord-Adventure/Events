...
NR
(1) Vous marchez et votre attention est attirée par un stand d'objets où le marchand semble en conversation avec un client. Vous vous y rendez, curieux de connaître la nature de leurs conversations. Vous observez la marchandise tout en écoutant le pauvre hère tenter de marchander un misérable article dont il a fort besoin. Finalement, dans un élan de bonté vous lui offrez et reprenez votre périple. 
(-50💰, +pv)

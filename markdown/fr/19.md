...
🐴 [3] Après avoir repéré un canasson bai laissé sans surveillance, vous vous en emparez afin de participer aux joutes. Vous voilà vainqueur ! L'épouse du Seigneur (ajouter nom lore ?) local vous donne en mains propres vos récompenses. (+600$, +item,-3h 🕑)

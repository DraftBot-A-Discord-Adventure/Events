...
⚔️ [3] Après avoir bien failli trouver la mort avec un coup d'hallebarde sertie de pierres précieuses vertes, vous finissez par mettre hors d'état de nuire votre dernier adversaire. Le Héraut d'Arme annonce votre victoire - Dame Seigneur vous apporte en personne votre récompense. (+200$, +1 item, -2h )
...
🗣️ Alors que vous hésitez, finalement galvanisé par le vacarme de la foule, vous vous joignez à leur entousiasme et acclamez les participants des différentes épreuves pendant des heures ! (🕑: -3h30) 

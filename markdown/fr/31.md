...
🏃 Continuer votre route. ( J'hésite à supprimer le choix, je pense qu'il faudrait le supprimer 🤔)
...
1. Les discussions ayant attisé votre curiosité, vous décidez d'assister au duel. Celui-ci se conclut très rapidement, avec le chevalier étranger pour vainqueur. Déçu, vous reprenez votre chemin. ( neutre )
...
Peu intéressé par ce duel, vous décidez de ne pas y prêter attention et poursuivez donc votre chemin. ( neutre )

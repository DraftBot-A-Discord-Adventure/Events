Vous apercevez le village Boug-Coton et décidez de vous y rendre. À peine arrivé vous entendez des rumeurs sur un duel contre un chevalier. Vous comprenez vite qu'il y a conflit entre le seigneur de ces lieux et celui du village voisin. Pour le régler, un combat est organisé entre leurs meilleurs combattants, mais tous ici sont médiocres et le duel débute bientôt.
...
END 1
Les discussions ayant attisé votre curiosité, vous décidez d'assister au duel. Celui-ci se conclut très rapidement, avec le chevalier étranger pour vainqueur. Déçu, vous reprenez votre chemin. 
( neutre )

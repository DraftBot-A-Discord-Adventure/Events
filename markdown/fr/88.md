...
💸5.
Après quelques vérifications, vous en venez à la conclusion que rien ne vous a été volé. À la recherche du voleur, vous vérifiez les alentours et finissez par trouver une maison. Vous toquez à la porte, une femme vous ouvre. Vous lui demandez si elle n'aurait pas vu quelqu'un, elle vous répond qu'elle n'a vu personne. Voyant le piteux état dans lequel vous êtes, elle vous propose de vous reposer chez elle. Vous acceptez volontiers son offre. Aussi vous prépare-t-elle un bon repas, vous vous sentez revigoré et remerciez vivement la femme avant de la quitter pour reprendre votre chemin.
( + 25 pv )

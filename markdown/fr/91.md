...
(1) Vous agrippez fermement les lianes avec vos mains. Vous vous hissez vers le haut de la paroi à l'aide vos bras musclés et aguerris, tandis que vos jambes vous propulsent vers le sommet à l'aide de vos pieds agiles. Bien que vous ne soyez pas doué en escalade, vous menez à bien cette mission. Arrivé au bout de votre ascension, vous regardez vos mains. Elles sont rouges et couvertes de petites écorchures que vous vous êtes faites sur les lianes rêches et sèches. 
(-5 heart)

(2) Grâce à votre agilité légendaire ainsi qu'à votre souplesse, vous réussissez à escalader les lianes sèches et rugueuses en quelques minutes seulement. Cette prouesse vous redonne un boost énergétique qui vous permet de marcher plus vite. Vous rattrapez sans problème votre retard.
(neutre)
...
(2) Vous allumez une torche avec un morceau de tissu et un bâton que vous trouvez à vos pieds, afin d'y voir plus clair. Alors que vous balayez l'espace, afin de repérer ce qu'il y a d'intéressant à dénicher, vous mettez accidentellement le feu aux lianes les plus sèches. Vous décidez de fuir dans une galerie mais, dans la précipitation, vous n'avez pas remarqué qu'elle est, elle aussi, couverte de lianes séchées. S'agissant d'une galerie sans issue, vous voilà piégé et cerné par le feu qui se propage rapidement. Vous n'avez plus aucune option.
(rip)

(3) Vous trouvez un reste de torche et réussissez à la rallumer. La lumière qu'elle projette vous permet d'apercevoir un lièvre s'enfuyant à toute vitesse. Vous le suivez jusqu'à la sortie. Vous décidez de l'attraper et d'en faire votre repas. Ensuite, vous continuez votre route. 
(-5min, +15 heart)


🚶‍♂️

(1) Vous observez cet étroit filet d'eau et vous remarquez qu'il suit l'ouverture de la crevasse. Après un bref moment de réflexion, vous vous souvenez de ce que votre tante disait toujours "tous les grands océans du monde ont d'abord été un petit ruisseau" et vous savez que les ruisseaux ont d'abord été des ru. Fort de vos connaissances, vous décidez donc de le suivre, pleinement confiant. Après quelques mètres, vous aperçevez une sortie.
(-10min, +15hp)
...
💀 
(1) Tout vous semble perdu au fond de cette crevasse sombre, froide et inhospitalière. Vous décidez de vous blottir dans un coin. Le froid et l'humidité vous engourdissent progressivement, vous couvrant d'un voile de douceur. Lentement, vous basculez dans un profond et mortel sommeil. 
(💀)

...
🔍3.
Vous fouillez les environs et ne mettez que peu de temps avant de retrouver votre compagnon admirant de magnifiques poissons nageant dans le lac. Ne souhaitant pas le déranger, vous reprenez votre route. Peut-être vos chemins se recroiseront-ils un jour.
Neutre

🔍4.
Alors que vous commencez à fouiller les lieux, vous entendez l'homme crier, vous trouvez d'où provient le son et voyez qu'il est avec des individus à l'amabilité douteuse. Vous vous rapprochez discrètement et sauvez votre compagnon qui vous offre de l'argent en guise de remerciement. Beaucoup d'argent...
+1000 or
